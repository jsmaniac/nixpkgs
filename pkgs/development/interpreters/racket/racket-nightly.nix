...
stdenv.mkDerivation rec {
  name = "racket-nightly-${version}";
  version = "6.4.0.4";

  src = fetchurl {
    url = "http://plt.eecs.northwestern.edu/snapshots/current/installers/racket-test-6.4.0.4-src-pre-built.tgz";
    sha256 = "081xhbyysd8zihddzdni6290hnbysrnq03cl92yp29kakcrn2rfb";
  };
